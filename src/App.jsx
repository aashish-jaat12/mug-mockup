...
import Mugmod2 from "./components/Mugmod2.jsx";
import Mugmod3 from "./components/Mugmod3";
import Mugmod4 from "./components/MugDom4.jsx";
    ...
    <div className="app-container">
      <div className="upload-section">
        <div className="header-content">
          ...
          <p className="subtitle">Upload your design and see it come to life on our premium mugs</p>
        </div>

        <div 
          className={`upload-container ${isDragOver ? 'drag-over' : ''} ${file ? 'has-file' : ''}`}

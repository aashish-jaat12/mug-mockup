...
const Mugmod4 = (props) => {
  ...
  const downloadMugImage = useCallback(
    async (mugRef, fileName) => {
      ...
      const designImage = mugContainer.querySelector(
        ".design-overlaysss, .design-overlaysss-right"
      );
      ...
      try {
        ...
        if (mugRef === leftMugRef) {
          ...
          const designHeight = 479 * (canvas.height / 300);
          const leftPosition = 100 * (canvas.width / 300);
          const topPosition = -86 * (canvas.height / 300); // Negative value from CSS
          ...
          const designWidth = 187 * (canvas.width / 300);
          const designHeight = 483 * (canvas.height / 300);
          const leftPosition = 16 * (canvas.width / 300);
          const topPosition = -85 * (canvas.height / 300); // Negative value from CSS
      ...
      <div className="mug-wrapper">
        ...
        <div className="mug left" ref={leftMugRef}>
          ...
          <img
            ...
            className={`design-overlaysss ${isDesignLoaded ? "visible" : ""}`}
            id="design-on-left"
          />
        </div>
        <button
      ...
      <div className="mug-wrapper">
        ...
        <div className="mug right" ref={rightMugRef}>
          ...
          <img
            ...
            className={`design-overlaysss-right ${
              isDesignLoaded ? "visible" : ""
            }`}
            id="design-on-right"
          />
        </div>
